...
import { GraphAI, agentInfoWrapper, type AgentFilterFunction } from "graphai";
...
import { graph_data, graph_data2, graph_data_co2, graph_data_http, graph_data_stream } from "@/graph/graph_data";
